...
# ---------------------------------------------------------------------------
WEIGHTS = {
    "trend": 0.25,          # 技術趨勢：站上 MA5/20/60 且多頭排列
    "momentum": 0.20,       # 動能：RSI14、MACD 柱狀圖
    "relative_strength": 0.20,  # 相對強度：對大盤/0050 的超額報酬
    "institutional_flow": 0.20,  # 個股法人動向：近N日法人買賣超
    "sector_flow": 0.15,    # 產業資金流向：重用熱力圖的法人排名邏輯
}
